  ...
  <section class="custom">
    <div class="row">
      <div class="col-12 col-md-4 col-l-4">
        ...
        <p>Offre Flash : Une boîte customisée par nos soins pour les 200 premières pré-commandes !</p>
      ...
      <div class="col-12 col-md-4 col-l-5">
        <div class="__icone">
          <li class="wishlist" title="Ajouter à ma sélection" onclick="">
            <svg xmlns="http://www.w3.org/2000/svg" width="24.198" height="22.235" viewBox="0 0 24.198 22.235">
              <path id="ico-heart-empty"
                    ...
                    transform="translate(-0.349 -0.384)" fill="#fff" stroke="#333" stroke-width="1"/>
            </svg>
          </li>
          <li class="share" title="Partager" onclick="">
            <svg width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path
                  ...
                  fill="#333333"/>
              <path d="M7.36245 11.2253L16.4643 15.7763L15.8319 17.0398L6.72998 12.4889L7.36245 11.2253Z"
                    fill="#333333"/>
              <path d="M15.8326 4.15869L16.4643 5.42362L7.36247 9.97315L6.73071 8.70821L15.8326 4.15869Z"
                    fill="#333333"/>
            </svg>
          </li>
        </div>
      ...
      <div class="col-12 col-md-4 col-l-3">
        <ul id="Menucustom">
          <li class="Courantmenu Menuactive"><a href="#chaussure">Chaussure entière</a></li>
          <li class="Courantmenu"><a href="#bande">Bandes</a></li>
          <li class="Courantmenu"><a href="#bandeLateral">Bandes latérales</a></li>
          <li class="Courantmenu"><a href="#pointe">Pointe</a></li>
          <li class="Courantmenu"><a href="#empeigne">Empeigne + Doublure</a></li>
          <li class="Courantmenu"><a href="#oeillet">Oeillet</a></li>
          <li class="Courantmenu"><a href="#languette">Languette arrière</a></li>
          <li class="Courantmenu"><a href="#etiquette">Étiquette de languette</a></li>
    ...
    <div class="slideCustom">
      ...
      <div class="__broderie" id="broderie">
        <div class="_broderieCustum">
          <div class="row">
            <div class="col-12 col-md-4 col-l-4">
              <p>Personnalise ta paire de sneakers avec tes mots, sur l’arrière de la chaussure.
                Entre le nom que tu souhaites y inscrire et visualise-le en direct.
              </p>
            </div>
            ...
            <div class="col-12 col-md-4 col-l-2">
              <form @submit="" action="">
                <p style="margin: 9px; font-weight: 700; font-size: 17px;">Couleur</p>
                <ul>
                  <li onclick="">
                    <input type="radio" value="" name="seltaille" id="couleurbroderie1">
                    <label for="name" data-value="" onclick=""></label>
                  </li>
                  <li onclick="">
                    <input type="radio" value="" name="seltaille" id="couleurbroderie2">
                    <label for="name" data-value="" onclick=""></label>
                  </li>
                </ul>
              </form>
      ...
      <div class="row">
        <div class="col-12 col-md-4 col-l-6">
          <ul>
            ...
            <li><strong>Griffe Veevid</strong> sur le côté de la chaussure</li>
            <li><strong>Perforations</strong> pour une meilleure aération</li>
          </ul>
        </div>
        <div class="col-12 col-md-4 col-l-6">
          <ul>
            <li><strong>Semelle intermédiaire</strong> en mousse avec amorti</li>
            <li><strong>Semelle extérieure</strong> en caoutchouc résistant</li>
            <li><strong>Semelle intérieur</strong> antidérapante, amovible, donne un soutien anatomique et augmente le
              confort
            </li>
          </ul>
          <div>
